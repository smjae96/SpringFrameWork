        ...
        <div class="inner-area">
            ...
            <form action="update.me" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="radio" class="mb-3" name="gender" id="Male" value="M" <c:if test="${loginUser.gender eq 'M'}">checked</c:if>>
                    <label for="Male">남자</label> &nbsp;&nbsp;
                    <input type="radio" class="mb-3" name="gender" id="Female" value="F" <c:if test="${loginUser.gender eq 'F'}">checked</c:if>>
